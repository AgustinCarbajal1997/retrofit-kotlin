...
import com.example.retrofitapi.components.MainImage
import com.example.retrofitapi.components.MainTopBar
import com.example.retrofitapi.components.MetaWebsite
import com.example.retrofitapi.components.ReviewCard
import com.example.retrofitapi.util.Constants.Companion.CUSTOM_BLACK
...
fun ContentDetailView(pad: PaddingValues, viewModel: GamesViewModel) {
    ...
    Column(
        ...
        Text(
            text = state.description_raw, color = Color.White, textAlign = TextAlign.Justify,
            modifier = Modifier
